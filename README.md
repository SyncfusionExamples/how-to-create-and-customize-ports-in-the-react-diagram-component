...
A quick-start React app that shows how to create and customize ports in the [React Diagram](https://www.syncfusion.com/diagram-sdk/react-diagram) Component. It explains how to create ports programmatically and add, remove, and update ports at run time using an external button click.
